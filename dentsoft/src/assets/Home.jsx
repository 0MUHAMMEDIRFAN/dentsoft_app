                          ...
                          `${hoveredIndex === appointmentIndex ?
                            `${providerIndex === 0 ? "left-1" :
                              (providerIndex === doctors.length - 1 && doctors.length > 1) ?
                                "right-1" :
                                "-left-5"} shadow-[0px_4px_30px_rgba(0,0,0,0.15)] -top-1/2 -ranslate-y-1/4 z-[50] w-[32vw]` : `${(providerIndex === doctors.length - 1 && doctors.length > 1) ? "right-[calc(10%-4px)]" : "left-1"} w-[90%]`} absolute rounded-md max-w-[32vw] text-xs text-[#444648] flex overflow-hidden cursor-pointer pointer-events-auto  min-h-[2rem] custom-transition`
                        }
                        style={{
